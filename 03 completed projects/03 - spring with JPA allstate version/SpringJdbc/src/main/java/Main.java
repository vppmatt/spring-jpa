...
//            }
        ...
        CreditCardTransactionDao dao = applicationContext.getBean(CreditCardTransactionDao.class);

        List<CreditCardTransaction> ccTransactionList = dao.getAllTransactionsForOrder("21212355");
